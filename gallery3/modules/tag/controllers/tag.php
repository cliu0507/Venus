    ...
    $template->set_global(
      array("page" => $page,
            ...
            "breadcrumbs" => array(
              ...
              Breadcrumb::instance(t("Category: %tag_name", array("tag_name" => $tag->name)),
                                   $tag->url())->set_last()),
            "children_count" => $children_count));
    $template->content = new View("dynamic.html");
    $template->content->title = t("Category: %tag_name", array("tag_name" => $tag->name));
    print $template;
