...
class dresssearchfromdb_Core {
  ...
  static function search_by_id($id, $album) {
    ...
    return dresssearchfromdb_Core::searchdb($perc_array);
  }
  
  static function search_by_file($file, $album) {
    list ($ignore, $perc_array) = dresssearch::searchByFile($file);

    return dresssearchfromdb_Core::searchdb($perc_array);
  }
  
  static function searchdb($perc_array) {
